    ...
    return (
        <>
            ...
            <div className="card-container contact-card-container">
                ...
                <a href="https://www.linkedin.com/in/damian-haziak-9721a8148/" target="_blank">
                    <div className="card-contact">
                        ...
                        <h3 className="card-title">Find out my education and career history on LinkedIn!</h3>
                    </div>
                </a>

                <a href="https://github.com/DamianHaziak/" target="_blank">
                    <div className="card-contact">
                        ...
                        <h3 className="card-title">Look through my projects on GitHub!</h3>
                    </div>
                </a>

                <a href="https://codepen.io/DamianHaziak" target="_blank">
                    <div className="card-contact">
                        ...
                        <h3 className="card-title">Browse through short snippets of my code on Codepen!</h3>
                    </div>
                </a>
